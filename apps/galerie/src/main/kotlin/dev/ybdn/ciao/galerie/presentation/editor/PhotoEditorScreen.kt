...
import dev.ybdn.ciao.galerie.data.edit.PhotoAdjustmentShader
...
import dev.ybdn.ciao.galerie.presentation.galerieSavedStateViewModel
...
fun PhotoEditorScreen(
    ...
    val viewModel = galerieSavedStateViewModel("editor:${item.key}") { container, app, handle ->
