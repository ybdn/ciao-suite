...
// Clé de signature release : fichier local non commité (voir README, section "Signature release").
// Si absent (CI, build local sans clé), le build release reste simplement non signé.
